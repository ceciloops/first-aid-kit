...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { category: @element.category, name: @element.name, picture: @element.picture } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { category: @element.category, name: @element.name, picture: @element.picture } }
